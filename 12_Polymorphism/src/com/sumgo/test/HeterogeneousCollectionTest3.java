...
// Heteroheneous : 이기종(서로 다른 종류)
// Heterogeneous Collection : 이기종간의 집합체  그래서 다형성이 필요한 것.!
public class HeterogeneousCollectionTest3 {
	...
	public static void main(String[] args) {
		...
		Employee[] emps = {
				...
				new Engineer("Gosling", new MyDate(1978, 1, 2), 3500, "JAVA", 200),
				new Secretary("Peter", new MyDate(1988, 1, 2), 3400, "Robert")
		};
		
		//Object Casting, instanceof 키워드
		for (Employee e : emps) {
			if (e instanceof Manager) ((Manager) e).chageDept("Marketing");
