 ...
 * 2. 다른 곳(다른 클래스)에서는 객체 생성을 하지 못하도록 막아준다. 다른데서 생성자 또 생성 못하게 
 * 	 private 생성자() {}
 * 3. 만들어 놓은 하나의 객체를 어디서든지 가져다  쓸 수 있도록 public 메소드를 만들어준다.
 */
public class EmployeeService {
	private static EmployeeService service = new EmployeeService(); //1  만들때 한번만 만들도록 private 
	private EmployeeService() {} //2
	public static EmployeeService getInstance() { //3 getter와 같은 것
		return service;
	}
